use crate::ecc::curves::bn254::{Bn254FqParams, Bn254FrParams};
...
pub type G1Affine = crate::ecc::groups::affine_element::AffineElement<GrumpkinG1Params>;
pub type G1Element = crate::ecc::groups::element::Element<GrumpkinG1Params>;
